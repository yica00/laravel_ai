...
INSERT INTO `articles` VALUES (8, '企业文化', '/images/1510804008912.png', NULL, '<p>WAP站企业文化</p>', 2, 1, 0, '/brand#culture', '2017-11-16 11:46:48', '2017-11-19 13:15:07', NULL);
...
INSERT INTO `articles` VALUES (71, '项目医生', '/images/1511060191121.png', '南充医疗美容医院院长', '<p>中国医疗美容整形协会会员</p><p>国家认证整形外科副主任</p><p>香港依美医疗美容集团总裁</p><p>“恒久美美雕”医疗美容系列项目创始人</p>', 63, 0, 200, '/', '2017-11-19 10:56:31', '2017-11-19 10:57:35', NULL);
INSERT INTO `articles` VALUES (72, '首页轮播图', NULL, NULL, NULL, 61, 0, 0, NULL, '2017-11-19 16:35:56', '2017-11-19 16:35:56', NULL);
INSERT INTO `articles` VALUES (73, '轮播图1', '/images/1511080630508.jpg', NULL, NULL, 72, 0, 0, NULL, '2017-11-19 16:37:10', '2017-11-19 16:37:10', NULL);
INSERT INTO `articles` VALUES (74, '轮播图2', '/images/1511080643727.jpg', NULL, NULL, 72, 0, 0, NULL, '2017-11-19 16:37:23', '2017-11-19 16:37:23', NULL);
INSERT INTO `articles` VALUES (75, '首页专家', '/images/1511085540906.png', '南充医疗美容医院院长', '<p>中国医疗美容整形协会会员</p><p>国家认证整形外科副主任</p><p>香港依美医疗美容集团总裁</p><p>“恒久美美雕”医疗美容系列项目创始人</p>', 60, 0, 0, '/wap/team', '2017-11-19 17:59:00', '2017-11-19 17:59:00', NULL);
...
CREATE TABLE `teams`  (
  ...
  `good_at` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `honor` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `photo` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `introduce` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `comtent` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  `deleted_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
