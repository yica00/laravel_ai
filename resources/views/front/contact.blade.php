...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(106.134065,30.865103);//定义一个中心点坐标
  ...
  map.addControl(ctrl_sca);
    ...
    //标注点数组
    var markerArr = [{title:"西山基地",content:"西山风景区栖乐垭村（西山草莓园旁）",point:"106.059033|30.810145",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ,{title:"搬罾果乐园基地",content:"搬罾果乐园内",point:"106.169135|30.898033",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ,{title:"搬罾青山湖基地",content:"搬罾青山湖景区",point:"106.17625|30.911434",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ];
    //创建marker
    function addMarker(){
