...
<div class="wap_box">
    ...
    <div class="w1160 clearfix">
        <div class="contact_map">
            <div style="width:100%;height:600px;" id="dituContent_2"></div>
            <div class="cont_box">
                <div class="txt_box">
                    <h2>美品佳装饰</h2>
                    <img src="images/qyimg.jpg" class="pic">
                    <ul class="add">
                        <li class="clearfix"><em class="fr">{{ session('setting')['fix_phone']  }}</em><img src="/images/ho_call1.png" alt=""  class="fl" /><span class="fl">座机：</span></li>
                        <li class="clearfix"><em class="fr">{{ session('setting')['phone']  }}</em><img src="/images/ho_phone1.png" alt=""  class="fl" /><span class="fl">电话：</span></li>
                        <li class="clearfix"><em class="fr">{{ session('setting')['qq']  }}</em><img src="/images/ho_qq1.png" alt=""  class="fl" /><span class="fl">Q Q：</span></li>
                        <li class="clearfix"><em class="fr">{{ session('setting')['bases']  }}</em><img src="/images/ho_add1.png" alt="" class="fl"  /><span class="fl">地址：</span></li>
                    </ul>
                </div>
            </div>
        </div>
