  ...
  <div class="w1160 clearfix">
    ...
    <div id="MagnifierWrap2">
        <div class="MagnifierMain">
          <img class="MagTargetImg" src="{{$article->thumbnail}}" data-src="{{$article->thumbnail}}">
        </div>
        ...
        <div class="spec-items"> 
          <ul>
            ...
            <li class="on"><img src="{{$img}}" data-lsrc="{{$img}}" data-maxSrc="{{$img}}"></li>
            @endforeach
          </ul>
        </div>
    </div>
