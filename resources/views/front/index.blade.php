    ...
    <div class="w1160 clearfix">
        <ul id="nav" class="nav clearfix">
            ...
            <li class="nLi">
                ...
                <ul class="sub">
                    <li><a href="about.html">神鹰简介</a></li>
                    <li><a href="team.html">教练团队</a></li>
                    <li><a href="honor.html">荣誉资质</a></li>
                </ul>
            </li>
            <li class="nLi">
                <h3><a href="expand.html">拓展培训</a></h3>
                <ul class="sub">
                    <li><a href="expand.html">企业拓展</a></li>
                    <li><a href="expand.html">亲子拓展</a></li>
                </ul>
            </li>
            <li class="nLi">
                <h3><a href="cs.html">真人CS</a></h3>
            </li>
            <li class="nLi">
                <h3><a href="camp.html">夏令营</a></h3>
            </li>
            <li class="nLi">
                <h3><a href="training.html">军训</a></h3>
            </li>
            <li class="nLi">
                <h3><a href="base.html">基地展示</a></h3>
                <ul class="sub">
                    <li><a href="base.html">西山基地</a></li>
                    <li><a href="base.html">搬罾青山湖基地</a></li>
                    <li><a href="base.html">搬罾果乐园基地</a></li>
                </ul>
            </li>
            <li class="nLi">
                <h3><a href="case.html">合作案例</a></h3>
            </li>
            <li class="nLi">
                <h3><a href="plan.html">活动方案</a></h3>
            </li>
            <li class="nLi">
