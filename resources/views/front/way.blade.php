...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(106.080557,30.824502);//定义一个中心点坐标
  ...
  map.addControl(ctrl_sca);
    ...
    //标注点数组
    var markerArr = [{title:"联手家居",content:"座机：0817-3631155<br/>电话：152-2812-5515或133-4076-5110<br/>地址：顺庆区潆华工业园区BD-C南充恩佩瑞机电有限公司内",point:"106.080171|30.824146",isOpen:1,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ];
    //创建marker
    function addMarker(){
