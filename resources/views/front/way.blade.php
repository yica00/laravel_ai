...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(106.011906,30.773297);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"嘉彩包装",content:"公司地址：南充市嘉陵区燕京大道工业园区（燕京啤酒厂前200米）",point:"106.00966|30.773141",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
