...
//        $shops = $this->getShop();
    ...
    public function face(){
        $image = public_path('images\1523927794889.jpg');
        $fcgi_result = get_face_features( $image);
        $obj = json_decode($fcgi_result);
        return $obj->data ;
    }
    ...
    public function news(){
        $articles = Article::select('id','thumbnail','title','created_at')->where('pid', 34)
            ->orderBy('serial_number','deac')->orderBy('id','asc')->paginate(3);
        return $articles;
    }
